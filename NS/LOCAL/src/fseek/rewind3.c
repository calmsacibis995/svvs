	...
	start
		...
		for( mode = 0; mode < NMODES; mode++ )
		{
			...
			case 0:
				...
				testing("Ftell and rewind of existing file opened for update (r+) at many points in file.");
				testing("Movement through file done by reading and writing.");
				testing("Expect a return value of filesize from ftell, undefined errno.");
				break;
			case 1:


				testing("Ftell and rewind of existing file opened for append and");
				testing("update (a+) at many points in file.");
				testing("Movement through file done by reading and writing.");
				testing("Expect a return value of 0 and current loc for ftell, undefined errno.");
				break;
			}
